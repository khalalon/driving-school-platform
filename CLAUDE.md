...
- Q-17 → D-40 (avoir), Q-18 → D-41 (absence non facturée, prépaiement rendu en avoir — confirmé), Q-19 → D-42 (libellés d'examen par type), Q-20 → D-43 (devise par école), appliquées en Phase 7. Reste **Q-21** (les deux procédures d'examen « pour le moment » : choix par l'instructeur, enregistré ou non — voir `DECISIONS.md`).
