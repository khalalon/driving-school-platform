...
- Les écrans instructeur `ExamRequests` et `TodayExams` contiennent encore des stubs (`// API call to …`) jusqu'à 6.5 ; `BookForStudentScreen` envoie encore un email dans `studentId` jusqu'à 6.4.
