...
- Plus aucun stub dans les écrans : chaque bouton appelle une méthode de service. Les libellés « Schedule » / « Reject » des examens (`ExamRequestsScreen`, `MyExamsScreen`) sont ceux du mobile d'origine, à revoir quand Q-19 sera tranchée.
...
- Plus aucune question ouverte au 19/09 : Q-17 → D-40 (avoir), Q-18 → D-41 (absence non facturée), Q-19 → D-42 (libellés d'examen par type), Q-20 → D-43 (devise par école). Elles s'appliquent en Phase 7 du plan.
